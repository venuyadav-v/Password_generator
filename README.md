...
1. Run the script:
   ...
   python Project2.py
   ```
2. Enter the number of letters, special characters, and numbers when prompted.
3. The script will print the password-building steps and the final generated password.
